...
describe("smartAsset()", () => {
  ...
  describe("load()", () => {
    test("runs for selected extensions", async () => {
    ...
    test("runs for any file if extensions is empty", async () => {
    ...
    test("runs using include/exclude micromatch", async () => {
    ...
    test("in rebase mode, returns rebased url as exports", async () => {
    ...
    test("in rebase mode with keepImport, returns rebased url as exports", async () => {
    ...
    test("in rebase mode, uses rebasePath", async () => {
    ...
    test("in rebase mode with keepImport, uses rebasePath", async () => {
    ...
    test("in rebase mode, uses publicPath", async () => {
    ...
    test("in inline mode, returns inlined url as exports", async () => {
    ...
    test("in inline mode, fallback to copy if maxSize exceeded", async () => {
    ...
    test("in copy mode, returns asset name as exports", async () => {
    ...
    test("in copy mode with keepImport, returns asset name as exports", async () => {
    ...
    test("in copy mode with keepImport with assetsPath, returns asset name as exports", async () => {
    ...
    test("in copy mode, uses publicPath (with ending slash)", async () => {
      const options = { url: "copy", extensions: [".png"], publicPath: "assets/" }
      const result = await smartAsset(options).load("test.png")
    ...
    test("in copy mode, uses publicPath (with absolute path)", async () => {
    ...
    test("in copy mode, uses useHash", async () => {
    ...
    test("in copy mode, uses keepName", async () => {
      hashFileMock.mockReturnValueOnce("0123456789")
    ...
    test("in copy mode, uses nameFormat without hash", async () => {
    ...
    test("in copy mode, uses nameFormat with hash", async () => {
      hashFileMock.mockReturnValueOnce("0123456789")
    ...
    test("in copy mode, uses hashOptions", async () => {
      hashFileMock.mockReturnValueOnce("0123456789")
    ...
    test("in unknown mode, gracefully fails", async () => {
  ...
  describe("transform()", () => {
    ...
    test("doesn't call load() if content was loaded by this plugin", async () => {
      const options = { url: "rebase", extensions: [".png"] }
      const plugin = smartAsset(options)
  ...
  describe("generateBundle()", () => {
    test("in copy mode, copies assets, file is used", async () => {
      const options = { url: "copy", extensions: [".png"] }
    ...
    test("in copy mode, copies assets, dir is used", async () => {
      const options = { url: "copy", extensions: [".png"] }
    ...
    test("in copy mode, uses assetsPath", async () => {
    ...
    test("in copy mode, doesn't copy if isWrite is false", async () => {
      const options = { url: "copy", extensions: [".png"] }
      const outputOptions = { file: "dist/bundle.js" }
    ...
    test("in copy mode, doesn't copy if emitFiles is false", async () => {
    ...
    test("in copy mode, warns on copy error", async () => {
    ...
    test("in copy mode, warns on directory creation error", async () => {
  ...
  describe("buildStart()", () => {
    test("clears asset list from previous run", async () => {
  ...
  describe("resolveId()", () => {
    test("resolves absolute imports", async () => {
      ...
      const importer = "/home/user/code/project/importer.js"

      const options = { url: "rebase", rebasePath: "/", keepImport: true, extensions: [".png"] }
      const result = await smartAsset(options).resolveId(source, importer)

      expect(result).toEqual({ external: true, id: "./home/user/code/project/test.png" })
    })

    test("resolves commonjs-wrapped imports", async () => {
      const source = "./src.svg"
      const importer = "\0./src.svg?commonjs-external"

      const options = { url: "rebase", keepImport: true, extensions: [".svg"] }
      const result = await smartAsset(options).resolveId(source, importer)

      expect(result).toEqual({ external: true, id: "./src.svg" })
    })
  })
})
